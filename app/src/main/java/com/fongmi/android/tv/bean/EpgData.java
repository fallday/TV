...
public class EpgData {
    ...
    public String format(String group, String tz) {
        int hours;
        ...
        String pattern = group.split("\\)")[1].split("\\}")[0];
        if (group.contains("(b)")) return new SimpleDateFormat(pattern, Locale.getDefault()).format(getStartTime() - hours * 60 * 60 * 1000L);
